...
import {
  ...
  const Nav = () => {
    ...
    return (
      ...
      >
        <div className="flex lg:flex-col gap-8 text-white bg-black p-4 justify-center items-center text-2xl rounded-full">
          {links.map((link, index) => {
            return (
              ...
              >
                ...
                <div className="text-blue-100">{link.icon}</div>
              </Link>
            );
          })}
        </div>
